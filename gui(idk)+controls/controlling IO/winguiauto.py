...
if __name__ == '__main__':
    ...
    win_version = {4: "NT", 5: "2K", 6: "XP" , 10:"2K"}[os.sys.getwindowsversion()[0]]
    ...
    time.sleep(.5)
    noButton = findControl(saveDialog, wantedClass="Button", wantedText="Don't Save")
    ...
    activateMenuItem(wordpadWindow, ['file', 'new'])
    time.sleep(.5)
